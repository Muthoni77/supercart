    ...
    >
      <div className=" flex flex-row items-center w-full md:flex-col md:items-start  space-y-2 md:space-y-1 md:w-1/5 text-[#4b5563]">
        <div className="w-1/2 flex items-center -ml-1 my-3 ">
          ...
          <span className="text-base md:text-xl  font-bold -mb-1 ml-1 md:ml-2 text-black">
            SuperCart
          </span>
        </div>
      ...
      <div className="flex flex-col space-y-2 w-1/2 mt-8 md:w-1/5 text-[#4b5563] text-sm md:text-base ">
      ...
      <div className="flex flex-col space-y-2 w-1/2 mt-8 md:w-1/5 text-[#4b5563] text-sm md:text-base ps-4 md:ps-0">
